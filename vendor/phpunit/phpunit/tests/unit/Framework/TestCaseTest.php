...
class TestCaseTest extends TestCase {
    ...
    public static function tearDownAfterClass() {
        unset(
                $GLOBALS['a'], $_ENV['b'], $_POST['c'], $_GET['d'], $_COOKIE['e'], $_SERVER['f'], $_FILES['g'], $_REQUEST['h'], $GLOBALS['i']
        );
    }

    public function testCaseToString() {
        $this->assertEquals(
                'PHPUnit\Framework\TestCaseTest::testCaseToString', $this->toString()
        );
    }
    ...
    public function testSkipsIfRequiresNonExistingOsFamily() {
        ...
        $this->assertEquals(1, $result->skippedCount());
        $this->assertEquals(
                'Operating system DOESNOTEXIST is required.', $test->getStatusMessage()
        );
    }
