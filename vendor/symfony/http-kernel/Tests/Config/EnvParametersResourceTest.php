...
class EnvParametersResourceTest extends TestCase {
    ...
    public function testGetResource() {
        $this->assertSame(
                ['prefix' => $this->prefix, 'variables' => $this->initialEnv], $this->resource->getResource(), '->getResource() returns the resource'
        );
    }

    public function testToString() {
        $this->assertSame(
                serialize(['prefix' => $this->prefix, 'variables' => $this->initialEnv]), (string) $this->resource
        );
    }
