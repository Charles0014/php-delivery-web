...
class NormalizerFormatterTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testExceptionTraceDoesNotLeakCallUserFuncArgs() {
        ...
        $this->assertSame(
                '{"function":"throwHelper","class":"Monolog\\\\Formatter\\\\NormalizerFormatterTest","type":"->","args":["[object] (Monolog\\\\Formatter\\\\TestInfoLeak)","' . $dt->format('Y-m-d H:i:s') . '"]}', $result['context']['exception']['trace'][0]
        );
    }
