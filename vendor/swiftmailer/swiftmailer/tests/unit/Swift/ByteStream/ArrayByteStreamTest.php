...
class Swift_ByteStream_ArrayByteStreamTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testReadingOddOffsetOnLastByte() {
        ...
        $this->assertEquals(['ab', 'cd', 'e'], $output, '%s: Bytes read from stream should be in pairs except final read'
        );
    }
    ...
    public function testBytesCanBeWrittenToStream() {
        ...
        $this->assertEquals(['a', 'b', 'c', 'd', 'e'], $output, '%s: Bytes read from stream should be from initial stack + written'
        );
    }
    ...
    public function testConstructorCanTakeStringArgument() {
        ...
        $this->assertEquals(['a', 'b', 'c'], $output, '%s: Bytes read from stream should be the same as bytes in constructor'
        );
    }
