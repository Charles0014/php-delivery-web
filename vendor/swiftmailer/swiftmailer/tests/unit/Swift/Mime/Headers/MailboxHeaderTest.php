...
class Swift_Mime_Headers_MailboxHeaderTest extends \SwiftMailerTestCase {
    ...
    public function testQuotesInNameAreQuoted() {
        ...
        $this->assertEquals(
                ['"Chris Corbyn, \"DHE\"" <chris@swiftmailer.org>'], $header->getNameAddressStrings()
        );
    }
    ...
    public function testEscapeCharsInNameAreQuoted() {
        ...
        $this->assertEquals(
                ['"Chris Corbyn, \\\\escaped\\\\" <chris@swiftmailer.org>'], $header->getNameAddressStrings()
        );
    }
    ...
    public function testUtf8CharsInDomainAreIdnEncoded() {
        ...
        $this->assertEquals(
                ['Chris Corbyn <chris@xn--swftmailer-78a.org>'], $header->getNameAddressStrings()
        );
    }
    ...
    public function testUtf8CharsInEmail() {
        ...
        $this->assertEquals(
                ['Chris Corbyn <chrïs@swïftmailer.org>'], $header->getNameAddressStrings()
        );
    }
    ...
    public function testMultipleAddressesCanBeSetAndFetched() {
        ...
        $this->assertEquals(
                ['chris@swiftmailer.org', 'mark@swiftmailer.org'], $header->getAddresses()
        );
    }
    ...
    public function testMultipleAddressesAsMailboxes() {
        ...
        $this->assertEquals(
                ['chris@swiftmailer.org' => null, 'mark@swiftmailer.org' => null], $header->getNameAddresses()
        );
    }
    ...
    public function testMultipleAddressesAsMailboxStrings() {
        ...
        $this->assertEquals(
                ['chris@swiftmailer.org', 'mark@swiftmailer.org'], $header->getNameAddressStrings()
        );
    }
    ...
    public function testNameIsEncodedIfNonAscii() {
        ...
        $this->assertEquals(
                'Chris =?' . $this->charset . '?Q?C=8Frbyn?= <chris@swiftmailer.org>', array_shift($addresses)
        );
    }
