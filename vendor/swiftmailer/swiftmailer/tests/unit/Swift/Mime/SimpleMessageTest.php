...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest {
    ...
    public function testDateIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Date' => $date]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testIdIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Message-ID' => $messageId]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testSubjectIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Subject' => $subject]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testReturnPathIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Return-Path' => $path]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testSenderIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Sender' => $sender]), $this->createEncoder(), $this->createCache()
        );
        $this->assertEquals(['sender@domain' => 'Name'], $message->getSender());
    }

    public function testSenderIsSetInHeader() {
        $sender = $this->createHeader('Sender', ['sender@domain' => 'Name'], [], false
        );
    ...
    public function testFromIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['From' => $from]), $this->createEncoder(), $this->createCache()
        );
        $this->assertEquals(['from@domain' => 'Name'], $message->getFrom());
    }

    public function testFromIsSetInHeader() {
        $from = $this->createHeader('From', ['from@domain' => 'Name'], [], false
        );
    ...
    public function testReplyToIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Reply-To' => $reply]), $this->createEncoder(), $this->createCache()
        );
        $this->assertEquals(['reply@domain' => 'Name'], $message->getReplyTo());
    }

    public function testReplyToIsSetInHeader() {
        $reply = $this->createHeader('Reply-To', ['reply@domain' => 'Name'], [], false
        );
    ...
    public function testReplyToIsAddedToHeadersDuringAddReplyTo() {
        $replyTo = $this->createHeader('Reply-To', ['from@domain' => 'Name'], [], false
        );
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Reply-To' => $replyTo]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testToIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['To' => $to]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testCcIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Cc' => $cc]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testBccIsReturnedFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['Bcc' => $bcc]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testPriorityIsReadFromHeader() {
        ...
        $message = $this->createMessage(
                $this->createHeaderSet(['X-Priority' => $prio]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testReadReceiptAddressReadFromHeader() {
        $rcpt = $this->createHeader('Disposition-Notification-To', ['chris@swiftmailer.org' => 'Chris']
        );
        $message = $this->createMessage(
                $this->createHeaderSet(['Disposition-Notification-To' => $rcpt]), $this->createEncoder(), $this->createCache()
        );
