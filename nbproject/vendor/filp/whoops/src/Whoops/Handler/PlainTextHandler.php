...
class PlainTextHandler extends Handler {
    ...
    private function getTraceOutput() {
        ...
        foreach ($frames as $frame) {
            ...
            $response .= sprintf(
                    $template, $line, $class, $frame->getFunction(), $frame->getFile(), $frame->getLine(), $this->getFrameArgsOutput($frame, $line)
            );
    ...
    private function getExceptionOutput($exception) {
        return sprintf(
                "%s: %s in file %s on line %d", get_class($exception), $exception->getMessage(), $exception->getFile(), $exception->getLine()
        );
    }
