...
class XliffLintCommandTest extends TestCase {
    ...
    public function testLintCorrectFile() {
        ...
        $tester->execute(
                ['filename' => $filename], ['verbosity' => OutputInterface::VERBOSITY_VERBOSE, 'decorated' => false]
        );
    ...
    public function testLintCorrectFiles() {
        ...
        $tester->execute(
                ['filename' => [$filename1, $filename2]], ['verbosity' => OutputInterface::VERBOSITY_VERBOSE, 'decorated' => false]
        );
