...
class ContextTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testGetUnusedCommandScopeVariableNames() {
        ...
        $this->assertEquals(
                ['__function', '__method', '__class', '__namespace', '__file', '__line', '__dir'], $context->getUnusedCommandScopeVariableNames()
        );
        ...
        $this->assertEquals(
                ['__method', '__class'], \array_values($context->getUnusedCommandScopeVariableNames())
        );
    }
