...
class MergeOperationTest extends AbstractOperationTest {
    ...
    public function testGetMessagesFromSingleDomain() {
        ...
        $this->assertEquals(
                ['a' => 'old_a', 'b' => 'old_b', 'c' => 'new_c'], $operation->getMessages('messages')
        );
    ...
    public function testGetResultFromIntlDomain() {
        $this->assertEquals(
            ...
            'messages+intl-icu' => ['d' => 'old_d', 'c' => 'new_c'],
                        ...
                        new MessageCatalogue('en', ['messages' => ['a' => 'old_a', 'b' => 'old_b'], 'messages+intl-icu' => ['d' => 'old_d']]), new MessageCatalogue('en', ['messages+intl-icu' => ['a' => 'new_a', 'c' => 'new_c']])
                )->getResult()
        );
    }
