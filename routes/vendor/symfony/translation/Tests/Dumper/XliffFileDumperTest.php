...
class XliffFileDumperTest extends TestCase {
    ...
    public function testFormatCatalogue() {
        ...
        $this->assertStringEqualsFile(
                __DIR__ . '/../fixtures/resources-clean.xlf', $dumper->formatCatalogue($catalogue, 'messages', ['default_locale' => 'fr_FR'])
        );
    }
    ...
    public function testFormatCatalogueXliff2() {
        ...
        $this->assertStringEqualsFile(
                __DIR__ . '/../fixtures/resources-2.0-clean.xlf', $dumper->formatCatalogue($catalogue, 'messages', ['default_locale' => 'fr_FR', 'xliff_version' => '2.0'])
        );
    }
    ...
    public function testFormatIcuCatalogueXliff2() {
        ...
        $this->assertStringEqualsFile(
                __DIR__ . '/../fixtures/resources-2.0+intl-icu.xlf', $dumper->formatCatalogue($catalogue, 'messages' . MessageCatalogue::INTL_DOMAIN_SUFFIX, ['default_locale' => 'fr_FR', 'xliff_version' => '2.0'])
        );
    }
    ...
    public function testFormatCatalogueWithTargetAttributesMetadata() {
        ...
        $this->assertStringEqualsFile(
                __DIR__ . '/../fixtures/resources-target-attributes.xlf', $dumper->formatCatalogue($catalogue, 'messages', ['default_locale' => 'fr_FR'])
        );
    }
    ...
    public function testFormatCatalogueWithNotesMetadata() {
        ...
        $this->assertStringEqualsFile(
                __DIR__ . '/../fixtures/resources-notes-meta.xlf', $dumper->formatCatalogue($catalogue, 'messages', ['default_locale' => 'fr_FR', 'xliff_version' => '2.0'])
        );
    }
