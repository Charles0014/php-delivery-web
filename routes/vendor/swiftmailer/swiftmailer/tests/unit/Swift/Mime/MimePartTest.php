...
class Swift_Mime_MimePartTest extends Swift_Mime_AbstractMimeEntityTest {
    ...
    public function testCharsetIsReturnedFromHeader() {
        ...
        $cType = $this->createHeader('Content-Type', 'text/plain', ['charset' => 'iso-8859-1']
        );
    ...
    public function testCharsetIsSetInHeader() {
        $cType = $this->createHeader('Content-Type', 'text/plain', ['charset' => 'iso-8859-1'], false
        );
    ...
    public function testFormatIsReturnedFromHeader() {
        ...
        $cType = $this->createHeader('Content-Type', 'text/plain', ['format' => 'flowed']
        );
        $part = $this->createMimePart($this->createHeaderSet([
                    'Content-Type' => $cType,]), $this->createEncoder(), $this->createCache()
        );
    ...
    public function testDelSpIsReturnedFromHeader() {
        ...
        $cType = $this->createHeader('Content-Type', 'text/plain', ['delsp' => 'no']
        );
        $part = $this->createMimePart($this->createHeaderSet([
                    'Content-Type' => $cType,]), $this->createEncoder(), $this->createCache()
        );
