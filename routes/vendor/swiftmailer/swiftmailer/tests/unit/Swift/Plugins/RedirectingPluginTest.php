...
class Swift_Plugins_RedirectingPluginTest extends \PHPUnit\Framework\TestCase {
    ...
    public function testArrayOfRecipientsCanBeExplicitlyDefined() {
        ...
        $this->assertEquals(
                $message->getTo(), ['fabien@example.com' => 'Fabien', 'lars-to@internal.com' => 'Lars (To)', 'god@example.com' => null]
        );
        $this->assertEquals(
                $message->getCc(), ['fabien@example.com' => 'Fabien', 'lars-cc@internal.org' => 'Lars (Cc)']
        );
